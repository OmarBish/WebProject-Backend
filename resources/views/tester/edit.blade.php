...
@section('content')
    @include('tester.partials.header', ['title' => __('Edit User')])   
                    ...
                    <div class="card-header bg-white border-0">
                        <div class="row align-items-center">
                            ...
                            <div class="col-4 text-right">
                                <a href="{{ route('tester.index') }}" class="btn btn-sm btn-primary">{{ __('Back to list') }}</a>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                        <form method="post" action="{{ route('testerr.update', $user) }}" autocomplete="off">
                            @csrf
                            @method('put')
