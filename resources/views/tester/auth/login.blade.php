            ...
            <div class="col-lg-5 col-md-7">
                <div class="card bg-secondary shadow border-0">
                    ...
                    <div class="card-body px-lg-5 py-lg-5">
                        <div class="text-center text-muted mb-4">
                            <small>
                                <a href="{{ route('testerRegister') }}">{{ __('Create new account') }}</a> {{ __('OR Sign in with these credentials:') }}
                            </small>
                            <br>
                            <small>
                        ...
                        <form role="form" method="POST" action="{{ route('testerLogin') }}">
                            @csrf
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-6 text-right">
                        <a href="{{ route('testerRegister') }}" class="text-light">
